...
- PRD 核心：`docs/prd_core.md`
- UI/视觉与原型：`docs/prd_ui.md`、`ui_prototype/*`
- 接口草案：`docs/openapi/openapi.yaml`（组件拆分文件同目录）
- 全栈方案：`docs/fullstack_plan.md`
...
> 字段与枚举请以 `docs/openapi/openapi.yaml` 为准。
